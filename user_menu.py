...
class Main(shortcut_menu_wx_skeleton.MainFrame):
    def __init__(self, parent):
        ...
        self.__input_status = {'sequence': False, 'action': False, 'row number to delete': False, 'computers status for current shortcuts': False, 'computer status for write shortcuts': False, 'remote argument': False, 'delete all': False, 'remove_computer': False}
...
#-------------------------------------------------------------------------------
    def add_new_shortcut_menu(self, event):
        """
        shows the add new shortcuts panel in the wx frame and adds all important
        information.
...
#-------------------------------------------------------------------------------
    def check_what_computer_was_chosen(self):
        """
        checks what computer was chosen by the user and if it wasn't my computer
        its returns a remote shortcut configuration.
        """
...
#-------------------------------------------------------------------------------
    def open_remote_url(self):
        ...
        if self.__argument_functions.get_argument():
            if self.__argument_functions.get_argument().split('.')[0] != 'www':      # the url must start with www
...
#-------------------------------------------------------------------------------
    def add_computers_to_computer_choice(self):
        ...
        if self.computer_choice.IsEmpty() or self.__input_status['computers status for current shortcuts']:
            ...
            self.__input_status['computers status for current shortcuts'] = False
...
#-------------------------------------------------------------------------------
    def show_loading_screen(self):
        """
        loads a waiting gif for the user and calls the find computers in network
        function
        """
...
#-------------------------------------------------------------------------------
    def delete_computer_from_saved_list(self, event):
        """
        deletes a computer from the saved data. that includes all it's shortcuts
